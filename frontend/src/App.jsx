...
export default function BlindTestForm() {
  ...
  const questions = [
    {
      id: 1,
      question: "高醫空污USR計畫與哪所大學簽署合作協議共同推動多語言衛教教材？",
      answers: [
        "高醫USR空氣污染計畫與文藻外語大學簽署合作協議，共同推動多語言衛教教材的研發與推廣。 合作方式主要涉及核心衛教教材的翻譯成多國語言，並進行雙語翻譯與內容優化以提升教材品質。 透過與文藻外語大學 的合作，計畫也將研發的教材在國際場合進行展示，以促進國際文化交流和知識共享。 此外，雙方還共同舉辦雙語講座與研討會，以更直接地促進跨文化知識的交流。",
        "高雄醫學大學USR空氣污染計畫與國立高雄師範大學簽署合作協議，結合雙方在醫學與語言教育領域的專長，合作推動多語言衛教教材，協助多語族群理解空污與健康知識。",
        "目前公開資訊未明確指出高雄醫學大學（高醫大）的USR空氣污染計畫與特定「大學」簽署合作協議共同推動多語言衛教教材。高醫大主要透過其內部師生團隊研發衛教教材，並與在地國小、醫院、圖書館等社區機構合作推廣，例如與小港醫院及當地小學合作推動空污課綱及衛教活動，也有與越南軍醫的國際交流但非共同推動多語言衛教教材。",
      ],
    },
    {
      id: 2,
      question: "高醫空污USR計畫當前主持人是誰?",
      answers: [
        "高雄醫學大學(高醫大)USR空氣污染計畫主持人為郭藍遠教授。他是高雄醫學大學健康科學院的院長，此計畫重點針對高齡、新住民及心理疾病患者，透過居家空污監測與專題健康促進介入，提供弱勢族群健康協助。",
    ...
    {
      id: 3,
      question: "高醫空污USR計畫主要場域涵蓋的四個行政區名稱。",
      answers: [
        "高醫大USR空氣污染計畫主要場域涵蓋小港區、林園區、前鎮區、大寮區。此計畫擴增場域，並新增USR學分學程，包含環境污染、健康促進等主題，致力於改善空污弱勢族群健康，並強化國際連結與產學合作，有助於社區福祉。",
        "高醫大USR空氣污染計畫主要場域涵蓋高雄市的小港區、林園區、大寮區與鳳山區，聚焦於高風險社區的環境健康與空污教育推廣。",
        "高雄醫學大學USR空氣污染計畫主要實踐場域涵蓋南高雄工業區周邊的行政區，包括小港區、林園區、前鎮區、大寮區。",
      ],
    },
    {
      id: 4,
      question: "以高醫空污USR計畫中的課程學分學程為例，請說明計畫中的「跨院系／跨校」課程設計如何影響學生的學習成效。",
      answers: [
        ...
        "高雄醫學大學空氣污染USR計畫的「空氣污染與健康微學程」等跨院系／跨校課程設計，透過整合公共衛生、呼吸治療、運動醫學等多元專業知識，並連結高中端學生參與「School Tutor跨域共學聯盟」，讓學生從理論到實踐多面向學習空污議題。這不僅深化了學生對空污健康影響的理解，也透過實際衛教活動培養其解決問題、團隊合作與社会關懷能力，顯著提升學習成效與應用知能。",
      ],
    },
    {
        id: 5,
        question: "高醫空污USR計畫在聯合國永續發展目標（SDGs）中，特別著重於「良好健康與福祉」（SDG 3）與「優質教育」（SDG 4）。請用說明為何這兩項目標會被作為本計畫的重點，並簡要說明其背後的意義。",
        answers: [
            "高雄醫學大學USR空氣污染計畫強調SDG3與SDG4，旨在透過環境教育提升居民對空氣污染的認知，並促進健康教育，特別是針對空氣污染引發的健康問題，如氣喘。此計畫的目標是改善居民健康與福祉，與聯合國SDG3 目標一致，致力於提升国民健康水平。計畫也關注優質教育，體現在國中健康學園的設立，旨在培養學生跨領域合作與問題解決能力，與SDG4強調的教育質量提升相符。 計畫強調SDG3與SDG4，不僅是呼應教育部USR政策，也反映了計畫核心價值，即透過教育與健康促進，提升社區居民的生活品質。SDG3關注健康福祉，意在減少環境污染對健康的負面影響；SDG4則希望透過教育提升居民自主解決環境問題的能力，使其能共同為健康環境貢獻力量。計畫的成功推動，需仰賴教育部USR政策的政策支持與資源投入。 此計畫的SDG9目標，則著重於推動產業、創新和基礎設施升級，例如跨校產學研合作及智能健康照護技術的應用。結合跨領域人才培育，並將學術知識轉化為地方發展動力，顯然展現計畫的永續發展策略。這與聯合國SDGs推動全球永續發展目標的整體方向一致。",
    ...
    },
    {
        ...
        answers: [
            "高雄醫學大學USR空氣污染計畫的核心理念「POWER」體現了大學社會責任的精神。此概念強調以人為核心，專業為本，並透過合作共享、實踐為體、創新為用，落實大學服務在地、解決社會問題的USR目標。教育部USR計畫亦以「在地連結」與「人才培育」為核心，高雄醫學大學的計畫正契合此政策方向。 「POWER」理念不僅回應教育部USR政策，更與政府強化空污治理的行動方案相輔相成。透過結合學術、醫療與社區力量，計畫 致力於提升社會影響力，並與國際USR趨勢接軌，促進永續發展。此核心理念並強調在大學特色類USR專案中，發揮在地實踐力、團隊合作力與跨域創新力。 計畫的推動體現了大學的社會責任，不僅是響應國家空污治 理議題，也旨在補足環境教育與健康促進需求。 透過「POWER」概念，計畫能更有效地調動各方力量，例如政府、企業與非營利組織，共同促進社區的可持續發展。",
    ...
    {
        id: 7,
        question: "假設你是參與高醫空污USR計畫課程的學生，請說明你如何運用課程中所學的知識與技能，協助社區推動「空污環境教育與健康促進」的衛教活動。請提出一個具體可行的活動流程。",
        answers: [
    ...
    {
        id: 9,
        question: "高醫空污USR計畫中已開發多種教育資源，例如多語繪本與肺健康衛教教材。假設你需要將這些素材推廣到非華語族群或不同文化背景社區，請設計三項具體的在地化應用策略，並簡要說明其操作方式與目的。",
        answers: [
            "高雄醫學大學USR空氣污染計畫已發展多語繪本與肺健康衛教教材，可透過與外語院校合作，將衛教教材翻譯成多種語言，促進國際文化交流，並方便非華語族群使用。針對新住民，可以推出定制化雙語教材，提高其 環境與健康意識，並結合海外成功案例進行本土化改造，更符合地方實際情況。此外，運用多媒體工具，例如視頻與動畫，使健康教育內容更直觀易懂，提升非華語族群的理解程度，藉此增進對環境變遷及其健康影響的認識。",
    ...
    {
        id: 11,
        question: "高醫空污USR計畫規劃了哪四大主軸? 請將這四大主軸分別對應出其主要利害關係人（例如學生、教師、社區居民、企業等），並說明每一主軸如何回應其對象的需求或關注點。",
        answers: [
    ...
    },
    {
        ...
        answers: [
            "高雄醫學大學第四期空污USR計畫在資源整合效率上，透過與新南向國家國際連結合作，以及校內外多元夥伴的投入，有效提供經費、設備與技術支持，確保計畫活動順利進行。計畫也設立空污環境與健康生活學分學 程，結合跨領域人才培育，強化了在地實踐深度，將學術知識轉化為解決地方空氣污染問題的能力，並發展新型學習成效量表及空污數據視覺化平台評估學習效果。為確保計畫能長遠持續發展，第四期計畫延續前期策略架構，並將成功經驗傳承應用到新的議題上，同時強調大學在面對地方空氣污染挑戰時應承擔的社會責任。此一三重結合能提升計畫的永續發展潛力，並與高等教育深耕計畫的目標相符。",
    ...
    },
    {
        ...
        answers: [
            "高雄醫學大學USR空氣污染計畫第四期，針對小學空污課綱，已研發新的學習成效量表，並定期舉辦工作坊進行課綱交流，另利用GIS平台整合空污數據進行評估。為強化社區自我保護意識，計畫透過實地體驗活動與互動宣講，讓居民了解空污對健康的危害，並鏈結大學課程與場域實踐，邀請跨院系教師帶領學生深入了解空污環境對健康的影響。為促進語言及文化交流，本計畫亦與文藻外語大學簽署MOU，將桌遊及繪本譯為多種語 言版本，擴大教學資源的多元性。 針對台灣新住民群體，計畫提供雙語衛教活動和專屬課程，以協助他們融入社區，且規劃一款多語化互動教材原型，預計可在30分鐘內完成空污防護知識學習，並評估學習成效。透 過工作坊，引導師生共學研發以空污為主題的衛教桌遊教材及繪本，例如112年產出的《植物的神奇魔法》，以及113年將出版的《美麗家園-Formosa》。本計畫持續推動雙語化教案教材，並結合海外實習計畫及國際專家學者進行交流合作，擴大影響力。",
    ...
    {
        id: 17,
        question: "請根據高醫空污USR計畫中數位教材應用經驗，設計一項結合空污即時資料與健康建議的數位互動工具",
        answers: [
            "高雄醫學大學USR空氣污染計畫透過多種方式普及健康促進與環境保護理念，包含課程設置、宣傳活動及公眾講座，強化民眾對空污與健康的關聯認識。計畫亦利用GIS平台整合空污數據，並研發新的學習成效量表，提升小學空污課綱的學習成效。此外，透過工作坊、研習及School Tutor跨域共學聯盟等活動，進一步推動環境教育與健康促進理念。 計畫滾動式增修太平國小課綱，並與成功大學結合GIS運用於太平國小課程中，計畫預計每年辦理工作坊研習至少兩場，並設計國中小學空氣污健康識能教材。透過數位化工具提升師生互動，採用在線討論、虛擬實境和互動教學軟件，並透過現場踏查和互動體驗，讓學生親自觀察空污現象。為強化民眾環境意識與健康福祉，計畫同時推展高年級課綱學習成效評估計畫。 要設計結合空污即時資料與健康建議的數位互動工具，可參考計畫中GIS平台整合空污數據的經驗，即時更新顯示空污指標，並提供使用者個人化的健康建議。透過互動教學軟件，使工具更具吸引力，並整合虛擬實境，加強民眾對空污影響的理解，提升學習效果與參與感。",
            "我設計的數位互動工具為「空污即時健康助手」，結合環境部API提供的即時空氣品質資料與個人健康狀態輸入（如年齡、呼吸疾病史），即時推播個別化防護建議與行動提醒，並整合教育素材如動畫或語音說明，提升使用者對空污與健康關聯的理解與反應能力。",
            "目前無法直接存取最新的USR計畫細節或其數位教材應用經驗，因此無法精準根據USR計畫的具體經驗設計數位互動工具。然而，根據一般數位教材應用原則，若要設計一個結合空污即時資料與健康建議的數位互動工具，可以考慮開發一個響應式網頁或行動應用程式，即時串接環保署的空污監測API，呈現PM2.5、PM10等數據及AQI指数。同時，系統可根據空污等級，自動顯示對應的健康防護建議，例如「敏感族群減少戶外活動」、「配戴口罩」或「開啟空氣清淨機」，並可結合地理位置服務，提供使用者所在地的即時資訊與個人化建議。",
        ],
    },
    {
        id: 18,
        question: "依照高醫空污USR計畫中已有的資源（如：智慧肺健康 App、肺健康圖卡、多語繪本、社區培力坊、跨校合作等），請設計一項三年期的創新行動方案，用於提升高風險社區居民在空氣污染下的健康素養與自我防護能力。",
        answers: [
            "高醫大空氣污染USR計畫已整合多項資源，可發展三年期創新行動方案，著重於強化高風險居民的健康素養。此方案將運用智慧肺健康App，結合多語繪本及肺健康圖卡，提供個人化健康監控與衛教資訊，降低語言與年齡層造成的理解障礙。透過社區培力坊、現場踏查及跨校合作，建立更深入的社區連結，並針對高齡者、新住民等弱勢族群提供客製化健康介入方案。 行動方案初期，聚焦於App使用者教育及圖卡繪本的普及，提升居民對空污影響及自我防護意識。中期則強化社區培力坊及現場踏查的頻率與深度，與地方政府、企業合作監測環境數據，並針對空污嚴重区域居民提供室內空氣清淨技術應用。後期將鼓勵跨領域師生共同設計更具互動性的衛教工具，並結合國中健康學園，培養年輕世代的環保意識。 此方案的核心是跨校科研力量的整合，加速智慧健康產品與應用的研發，例如結合GIS、大數據提供更精準的健康預警。同時，鼓勵師生運用創新工作坊，開發實用的桌遊與互動教材，並強化國中健康學園的課程實踐，提升年輕世代的參與度與健康素養。 整個三年期行動方案以居民參與為核心，透過多樣化的資源整合與科技應用，期能有效提升高風險社區居民在 空氣污染下的健康素養與自我防護能力，建立更健康、永續的社區環境。",
  ...
  // *** 新增：用於控制頁面流程的 state ***
  const [currentStep, setCurrentStep] = useState('info'); // 'info' 或 'questions'
  ...
  const handleSubmit = async (e) => {
    ...
    // 再次驗證以防萬一，雖然理論上走不到這一步
    if (!formData.identity || !formData.gender || !formData.participationYear || !formData.llmFamiliarity) {
      alert("請填寫所有的基本資料欄位後再提交！");
      return; 
    }

    const isConfirmed = window.confirm("您確定要提交問卷嗎？提交後將無法修改。");
    if (!isConfirmed) {
      return;
    }
    ...
    try {
      ...
      setCurrentStep('info'); // 提交後回到基本資料頁
      window.scrollTo(0, 0);
    } catch (error) {
                  ...
                  <div className="animate-fade-in">
                    ...
                    <div className="p-4 sm:p-6 border-t-4 border-gray-400 rounded-lg shadow-sm bg-white mb-12">
                        ...
                        <div className="space-y-6 bg-gray-50 p-4 sm:p-6 rounded-md">
                            <div>
                                <label className="block font-semibold text-gray-700 mb-1">身分 <span className="text-red-500">*</span></label>
                                <select
                                    name="identity"
                            ...
                            <div>
                                <label className="block font-semibold text-gray-700 mb-1">生理性別 <span className="text-red-500">*</span></label>
                                <select
                                    name="gender"
                                    className="border border-gray-300 p-2 w-full rounded-md bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    required
                            ...
                            <div>
                                <label className="block font-semibold text-gray-700 mb-1">參與時間（年） <span className="text-red-500">*</span></label>
                                <select
                            ...
                            <div>
                                <h3 className="block font-semibold text-gray-700 mb-2">您對大型語言模型技術的熟悉程度為： <span className="text-red-500">*</span></h3>
                    ...
                    <div className="mt-10 text-center">
                      <button 
                          type="button" // 關鍵：設為 type="button" 才不會觸發 form 的 onSubmit
                          onClick={handleStartAnswering}
                          className="bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors focus:outline-none focus:ring-4 focus:ring-blue-300"
                      >
                          開始填答
                      </button>
                    </div>
                  ...
                  <>
                                ...
                                >
                                    ...
                                    <Draggable key={`${currentQuestion.id}-${answerIndex}`} draggableId={`${currentQuestion.id}-${answerIndex}`} index={rankIndex}>
                                        ...
                                        <div
                                            ...
                                            className={`border rounded-lg flex flex-col sm:flex-row items-stretch overflow-hidden transition-shadow ${snapshot.isDragging ? 'shadow-2xl bg-blue-50' : 'bg-white shadow-sm'}`}
                                        >
                                            <div className="w-full sm:w-24 flex-shrink-0 flex flex-row sm:flex-col items-center justify-between sm:justify-center p-3 bg-gray-50 sm:p-4">
                                                <span className="text-lg font-bold text-blue-600">第 {rankIndex + 1} 名</span>
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400 cursor-grab sm:mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className="mt-10 flex justify-between items-center">
                        ...
                        {currentQuestionIndex < questions.length - 1 ? (
                            ...
                            <button 
                                type="submit" // 只有這個按鈕是 type="submit"
